...
Posters can be created in PowerPoint or Adobe Illustrator. And example poster that you can use as a template can be found [here](https://utah.instructure.com/courses/685329/files/115014166?module_item_id=14307103). The Marriott library [guidelines](https://campusguides.lib.utah.edu/posters) are detailed and helpful (especially [tips for graphic design](https://campusguides.lib.utah.edu/c.php?g=160626&p=1051976)). 
...
## References
- You are encouraged to use a citation manager (e.g., Zotero) to generate a bibliography.
