...
**Before you start** this assignment, watch [this video](https://youtu.be/08uylSp-CuI) to understand the logic of hypothesis testing. We use different statistical tests depending on the nature of the independent (or predictor, explanatory) variable and the dependent (or outcome, response) variable. It is important to correctly identify the type of variables involved in a hypothesis (or research question).  
